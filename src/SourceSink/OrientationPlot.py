...
if __name__ == '__main__':
    ...
    plotter1 = OrientationPlot(max_samples=50, format_str=format_str, axis_length=0.1, use_timestamp=use_timestamp)
    plotter2 = OrientationPlot(max_samples=200, format_str='%f,%f,%f', use_timestamp=use_timestamp)
    plotter3 = OrientationPlot(max_samples=200, format_str='%f,%f,%f,%f', use_timestamp=use_timestamp)
