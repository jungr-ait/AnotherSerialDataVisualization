...
class View:
    ...
    def create_widgets(self):
        ...
        #button
        self.b1LoadImg = tk.Button(self.topFrame2, text = "Load Image",command = self.btn_loadImg)
        self.b2LineDetect = tk.Button(self.topFrame2,text = "Line Detection",command = self.btn_lineDetect)
        #scale bar
